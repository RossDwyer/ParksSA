...
plotPropTim()
plotPropTim(sxaxis=10) # plots wih mps size limited to 10 km
plotPropTim(sxaxis=10,sd=TRUE) # plots wih mps size limited to 10 km
...
plotNoInd <- function(F1="0.05"){
  ...
  fig5 = fig5 %>%  # Add formatiing of plot xy axis and hover text with full MPA dim range
    layout( title = paste0(F1*100,"% annual fishing mortality"),
