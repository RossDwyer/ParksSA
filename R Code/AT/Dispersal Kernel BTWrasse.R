...
Dispersal_Timescales_BTWrasse <- list(Daily=dispersal_summary_day,
                                     Weekly=dispersal_summary_week,
                                     Monthly=dispersal_summary_month)
saveRDS(Dispersal_Timescales_BTWrasse, file = "Data/Dispersal_Timescales_BTWrasse.RDS") # Save to github

##############################################


# Compute a histogram of distance per week
disp.hist <- Dispersal_Timescales_BTWrasse$Weekly %>%
  ggplot(aes(maxDistkm)) + geom_histogram() +theme_bw()
# Compute a histogram of num receiver stations
stat.hist <- Dispersal_Timescales_BTWrasse$Weekly %>%
